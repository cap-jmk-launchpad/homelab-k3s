...
| Research gateway | `li-research` | **30487** | `research.klaut.pro` | **Live** — NodePort 30487 (30486 = GitLab Pages) |
...
| `research-api` | `klaut-research-gateway` @ `research.klaut.pro` | Literature search + reports — NodePort **30487**; persist runs on warm-index PVC |
